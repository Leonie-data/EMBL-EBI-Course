...
For example typing `ls test_data/*.pdf` in the `test_data/` directory (which does not contain any pwd

PDF files) results in a message that there is no file called `*.pdf`.
...
Get the sorted, de-duplicated fifthnn column of the example.csv file, then keep the entries that contain the word '27'.
